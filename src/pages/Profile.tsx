...
import { User, Shield, Key, Award, Terminal, Globe } from "lucide-react";
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div className="px-3 py-1 bg-[#39de7f]/10 border border-[#39de7f]/20 rounded-lg">
              <span className="text-[10px] font-black text-[#39de7f] uppercase italic tracking-widest">
                Lead Dev
              </span>
            </div>
          </div>

          <p className="text-gray-500 text-[11px] font-black uppercase tracking-[0.4em] italic">
            System Administrator & Lead Architect
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-[#080808] border border-white/5 p-8 rounded-[2.5rem]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <ProfileItem label="User ID" value="#0247-GEGA" icon={Terminal} colorClass="text-gray-400" />
              <ProfileItem label="System Status" value="Bypass Active" icon={Award} colorClass="text-yellow-500" />
              <ProfileItem label="Auth Method" value="Hardware ID" icon={Key} colorClass="text-blue-500" />
              <ProfileItem label="Global Rank" value="Elite Member" icon={Shield} colorClass="text-[#39de7f]" />
            </div>
          </div>

          <div className="bg-[#080808] border border-white/5 p-8 rounded-[2.5rem]">
            <h3 className="text-white font-black italic uppercase text-lg mb-6 tracking-tight">
              Account Activity
            </h3>
        ...
        <div className="space-y-6">
          <div className="bg-[#39de7f] p-10 rounded-[3rem] text-black shadow-[0_0_30px_rgba(57,222,127,0.1)]">
            <h3 className="font-black italic uppercase text-2xl mb-8 leading-none">
              Staff<br />Access
            </h3>
          ...
          <div className="bg-[#080808] border border-white/5 p-8 rounded-[2.5rem]">
            ...
            <p className="text-white font-black text-xl mt-4 italic uppercase tracking-tight">
              Connected
            </p>
            <p className="text-[10px] text-[#39de7f] font-bold uppercase mt-1">
              Frankfurt Node-01
            </p>
          </div>
        </div>
...
const ProfileItem = ({ label, value, icon: Icon, colorClass }: ProfileItemProps) => (
  <div className="flex items-center gap-5 p-5 bg-black border border-white/5 rounded-2xl hover:border-[#39de7f]/20 transition-all">
    <div className={`p-3 bg-white/5 rounded-xl ${colorClass}`}>
      <Icon size={18} />
    </div>
    <div>
      <p className="text-[9px] font-black text-gray-600 uppercase tracking-widest mb-1 italic">
        {label}
      </p>
